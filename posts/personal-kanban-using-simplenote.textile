...
* "Scrivener":http://www.literatureandlatte.com/scrivener.php
  如果你的工作涉及到任何形式的书写，买 Scrivener 的45美元可以是你最好的一笔投资。在这里，相关的功能是 Scrivener 可以用看板的形式显示一个集合中的文件。需要做的就是[-分别导入 backlog，doing 和 done 等等文件夹里的文件-][+与笔记文件夹同步，然后在 Scrivener 中搜寻带有需要的标签的文件并保存为智能集合+]，再将 Corkboard 视图垂直分割，分别显示不同的[-文件夹-][+集合+]，如图所示：
